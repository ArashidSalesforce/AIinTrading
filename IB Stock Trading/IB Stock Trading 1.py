    ...
    try:
        ...
        class TestApp(TestWrapper, TestClient):     
            ...
            def create_sell_order(self, contract):
                ...
                limit_price = math.ceil(market_price * 1.00001 * 100) / 100
            ...
            def tickPrice(self, reqId, tickType, price, attrib):
                ...
                #tickType == 4:
                    #time.sleep(3)
                    pri = price
                print("Line 229: The current ask price is: ", price)
                print("Line 230: The current ask pri is: ", pri)
                #app.disconnect()
        ...
        def quantityCalc():
            ...
            #quan = math.floor(possibleShares * .05)
            quan = 170
            qua = quan
            #quan = 70
            #print("Line 315: ")
